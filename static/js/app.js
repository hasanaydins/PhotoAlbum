...
window.addEventListener("load", function()     {
    ...
    var albumListe = document.getElementById("albumListe"); /// Sol taraftaki liste id si
    ...
    XHR.open("GET", "https://jsonplaceholder.typicode.com/albums", false);
    XHR.send();
});
 ...
 Array.from(albumItems).forEach(function(elm) {   // for ile her biri icin click event atandı
    ...
    elm.addEventListener("click", function() { // her album icin click event atandı
       ...
       // --------------  Tam boyut fotoların getirilmesi --------------- //
        ...
        XHR.open("GET", `https://jsonplaceholder.typicode.com/albums/${albumId}/photos`, false);
        XHR.send();
  });
});